...
ffmpeg -framerate 60 -pattern_type glob -i "$SERVER_DIR/$HUMAN_DATE/*.jpg" -s:v 1600x1200 -c:v libx264 -crf 25 -pix_fmt yuv420p "$SERVER_DIR/$HUMAN_DATE/Dorm Timelapse $TIMELAPSE_DATE.mp4"
